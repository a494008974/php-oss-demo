<style>
    body{
        background: url("../../images/bg_login.jpg") no-repeat fixed;
...
<template>
    <div id="content">
        <div class="login-header">
            <h1>{{login.language.login_title}}</h1>
        </div>
        <form>
        ...
        <div class="logon-box">
            <a href="">{{login.language.login_forget}}</a>
            <a href="">{{login.language.login_register}}</a>
        </div>
